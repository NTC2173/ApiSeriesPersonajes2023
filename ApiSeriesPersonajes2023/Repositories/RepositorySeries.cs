...
namespace ApiSeriesPersonajes2023.Repositories
{
    public class RepositorySeries
    {
        ...
        //PARA A MODO DE ORGANIZACION DEL CODIGO PODEMOS UTILIZAR UNA HERRAMIENTA, PARA DIFERENCIAR
        //MEJOR DE LOS METODOS QUE PERTENECEN A UNA TABLA SERIES Y OTRA PERSONAJES, EN ESTE CASO
        ...
        {
            var conulta = from datos in this.context.Series
        ...
        public List<Personaje> GetPersonajesSeries(int idserie)
        {
        ...
        {
            var consulta = from datos in this.context.Personajes where datos.IdPersonaje == idpersonaje
                           select datos;
        ...
        public async Task InsertPersonaje(int id, string nombre, string imagen, int idserie)
        {
